...
export default function Homepage() {
  return (
    <>
      <Head>
        <title>ecovium - Simple Chain Logistics Solution</title>
      ...
      <div className="ecovium-design-by" data-model-id="67:91">
        ...
        <div className="text-wrapper">Product Categories</div>
        ...
        <div className="text-wrapper-9">Customs</div>
        <div className="text-wrapper-10">Transport</div>
        ...
        <p className="discover-our">
          Discover our solutions:<br />ATLAS Export / Import<br />Confirmation of arrival<br />Sanctions list check<br />Export
          control<br />Preferential Origin (EU)<br />SAP® Add-ons
        </p>
        <div className="text-wrapper-12">Explore Consutiong Services</div>
        ...
        <div className="text-wrapper-20">Talk to field expert</div>
        <div className="text-wrapper-21">German</div>
        <div className="text-wrapper-22">FAQ</div>
        <div className="text-wrapper-23">Solutions</div>
        <div className="text-wrapper-24">Resources</div>
        ...
        <p className="element-ecovium-legal">
          <a href="https://ecovium.com/en/" target="_blank" rel="noopener noreferrer">
            <span className="span">© 2024 ecovium</span>
          </a>
          <span className="text-wrapper-31">&nbsp;&nbsp;</span>
          <a href="https://ecovium.com/en/legal-notice" target="_blank" rel="noopener noreferrer">
            <span className="span">Legal notice</span>
          </a>
          <span className="text-wrapper-31">&nbsp;&nbsp;<br /></span>
          <a href="https://ecovium.com/de/datenschutzinformation" target="_blank" rel="noopener noreferrer">
            <span className="span">Data protection</span>
          </a>
          <span className="text-wrapper-31">&nbsp;&nbsp;</span>
          <a href="https://ecovium.com/en/terms" target="_blank" rel="noopener noreferrer">
            <span className="span">GTC</span>
          </a>
        </p>
        <div className="rectangle-5"></div>
        <div className="rectangle-wrapper"><div className="rectangle-6"></div></div>
        <div className="rectangle-7"></div>
        <div className="text-wrapper-32">Download Brochure</div>
        <div className="text-wrapper-33">Support Beyond Software</div>
        <div className="group-5">
          <div className="rectangle-8"></div>
          <div className="text-wrapper-34">24/7 Customer Support</div>
        ...
        <div className="group-6">
          <div className="rectangle-8"></div>
          <div className="text-wrapper-34">Community of Peers</div>
          <p className="text-wrapper-35">
            Connect, learn, inspire, and grow your online community within customs, warehousing, shipping and transport,
        ...
        <div className="group-7">
          <div className="rectangle-8"></div>
          <div className="text-wrapper-36">Seamless Carrier Integrations</div>
          <p className="text-wrapper-35">
        ...
        <div className="group-8">
          <div className="rectangle-8"></div>
          <div className="text-wrapper-37">On-Demand Trainings</div>
          <p className="text-wrapper-35">
        ...
        <p className="element-info">
          +49 211 8492 0<br />Info@ecovium.com<br />Justus-von-Liebig-Straße 3<br />31535 Neustadt<br />Germany
        </p>
